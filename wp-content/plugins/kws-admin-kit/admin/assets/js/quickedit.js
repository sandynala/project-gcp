...
function kws_quick_edit() {
    ...
    $('#bulk-edit')
        ...
        .append(
            $('#bulk-edit #kws_bulk_edit')
        );

    $('.inline-edit-row').not('#bulk-edit')
        .find('.inline-edit-col-right:first .inline-edit-col')
        .append(
            $('.inline-edit-row #kws_quick_edit')
        );
    ...
    inlineEditPost.edit = function(id) {
        ...
        $('select[name="kws_post_type"] option[value="' + post_type + '"]', edit_row).attr('selected', 'selected');
    };
}
