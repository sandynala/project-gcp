...
$current_scheme = kws_get_user_admin_color();
if ('fresh' == kws_get_user_admin_color() || '' == kws_get_user_admin_color())
{
    $c = $one;
}
else if ('light' == kws_get_user_admin_color())
{
    $c = $two;
}
else if ('blue' == kws_get_user_admin_color())
{
    $c = $three;
}
else if ('coffee' == kws_get_user_admin_color())
{
    $c = $four;
}
else if ('ectoplasm' == kws_get_user_admin_color())
{
    $c = $five;
}
else if ('midnight' == kws_get_user_admin_color())
{
    $c = $six;
}
else if ('ocean' == kws_get_user_admin_color())
{
    $c = $seven;
}
else if ('sunrise' == kws_get_user_admin_color())
{
    $c = $eight;
} ?>
...
<style type="text/css" media="screen">
    ...
    .wrap h2, #post-body-content > h2, .widefat thead th, .widefat tfoot th, .kws-settings .pageSection section, #kws__colorSchemes .colorNav ul, #welcome-panel, #wp-content-editor-tools, .wp-editor-expand #wp-content-editor-tools {
    ...
    div.publishpress-admin header img {
        display: none !important;
    }

    div.publishpress-admin footer {
        display: none !important;
    }
