...
class KWSES_WC {
	...
	public function admin_init() {
		add_filter( 'kwses_meta_keys_query', array( $this, 'product_meta_keys_query' ) );
		add_filter( 'kwses_meta_keys', array( $this, 'add_hidden_product_meta_keys' ) );
		add_filter( 'kwses_tax_args', array( $this, 'filter_product_taxonomy_args' ) );
		add_filter( 'kwses_post_types_args', array( $this, 'filter_post_types_args' ) );
	}
	...
	/**
	 * Display only product taxonomies in KWSES settings.
	 *
	 * @since 2.0
	...
	/**
	 * Display only product CPT in KWSES settings.
	 *
	 * @since 2.0
