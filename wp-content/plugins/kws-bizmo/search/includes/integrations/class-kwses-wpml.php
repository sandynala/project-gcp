...
class KWSES_WPML {
	...
	/**
	 * Copy kwsessid parameter to translated URLs in language switcher.
	 *
	 * @since 2.0
	...
	public function ls_copy_query_str( $parameters ) {
		if ( ! is_array( $parameters ) ) {
			return array( 'kwsessid' );
		}

		if ( ! in_array( 'kwsessid', $parameters, true ) ) {
			array_push( $parameters, 'kwsessid' );
			return $parameters;
		}
	...
	public function remove_wpml_meta_box() {
		remove_meta_box( 'icl_div_config', 'kwses_setting', 'normal' );
	}
}
