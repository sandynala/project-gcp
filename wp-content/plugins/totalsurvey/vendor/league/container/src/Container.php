...
namespace TotalSurveyVendors\League\Container;
! defined( 'ABSPATH' ) && exit();


use TotalSurveyVendors\League\Container\Definition\{DefinitionAggregate, DefinitionInterface, DefinitionAggregateInterface};
use TotalSurveyVendors\League\Container\Exception\{NotFoundException, ContainerException};
use TotalSurveyVendors\League\Container\Inflector\{InflectorAggregate, InflectorInterface, InflectorAggregateInterface};
use TotalSurveyVendors\League\Container\ServiceProvider\{
    ServiceProviderAggregate,
    ServiceProviderAggregateInterface,
    ServiceProviderInterface
};
use TotalSurveyVendors\Psr\Container\ContainerInterface;
