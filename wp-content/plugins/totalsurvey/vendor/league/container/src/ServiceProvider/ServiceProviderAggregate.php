...
use Generator;
use TotalSurveyVendors\League\Container\{ContainerAwareInterface, ContainerAwareTrait};
use TotalSurveyVendors\League\Container\Exception\ContainerException;
...
class ServiceProviderAggregate implements ServiceProviderAggregateInterface
{
    ...
    public function add($provider) : ServiceProviderAggregateInterface
    {
        ...
        throw new ContainerException(
            ...
            'of (\TotalSurveyVendors\League\Container\ServiceProvider\ServiceProviderInterface)'
        );
    }
