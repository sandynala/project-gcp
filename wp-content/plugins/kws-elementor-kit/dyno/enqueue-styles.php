...
class CSX_Enqueue_Style {
  ...
  public function frontend_styles() {
    ...
    wp_enqueue_style('csx-styles', plugin_dir_url(__DIR__) . 'assets/css/csx-style.css',array(),CFTKEK_VER);
    wp_enqueue_script('csx-script', plugin_dir_url(__DIR__) . 'assets/js/csx_base.js',array(),CFTKEK_VER);
