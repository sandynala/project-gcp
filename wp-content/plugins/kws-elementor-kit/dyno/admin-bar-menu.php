...
class CSX_Admin_Bar_Menu {
  ...
  public static function write_js(){
    if(is_admin_bar_showing()){
      ...
      echo '<script src="'.CFTKEK_URL.'assets/js/csx_admin_bar_menu.js"></script><script>';
      echo 'CSX_update_admin_bar_menu('.self::get_menu_args().');';
      echo '</script>';
    }
  }
