<?php
	...
	namespace KwsElementorKit\Includes\Controls\SelectInput;
	
	defined( 'ABSPATH' ) || die();
 	class KwsElementorKit_Dynamic_Select_Input_Module {
		...
		public function init() {
			add_action( 'wp_ajax_kek_dynamic_select_input_data', array( $this, 'getSelectInputData' ) );
		}
		...
		public function getTerms() {
			...
			if($this->getPostType() == '_kws_elementor_kit_pro_related_post_type'){
			    $post_type = 'any';
	...
	function kwsElementorKit_dynamic_select_input_module() {

		return KwsElementorKit_Dynamic_Select_Input_Module::get_instance();
	}
	kwsElementorKit_dynamic_select_input_module()->init();
