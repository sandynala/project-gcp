...
namespace KwsElementorKit\Modules\TestimonialGrid\Widgets;
...
class Testimonial_Grid extends Group_Control_Query
{
    ...
    {
        return 'kek-testimonial-grid';
    }
    
    public function get_title()
    {
        return CFTKEK . esc_html__( 'Testimonial Grid', 'kws-elementor-kit' );
    }
    
    public function get_icon()
    {
        return 'kek-widget-icon kek-icon-testimonial-grid';
    }
    ...
    public function get_style_depends()
    {
        ...
        if ( $this->kek_is_edit_mode() ) {
            ...
            return [ 'kws-elementor-kit-font', 'kek-testimonial-grid' ];
        }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_responsive_control( 'columns', [
            ...
            'selectors'      => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-style-1' => $column_size,
        ],
            'condition'      => [
            'grid_style' => [ '1' ],
        ],
        ...
        $this->add_responsive_control( 'column_gap', [
            ...
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-post-grid' => 'grid-gap: {{SIZE}}{{UNIT}};',
        ],
        ] );
        $this->add_responsive_control( 'secondary_image_height', [
            ...
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-style-2 .kek-item:nth-child(4n+2), {{WRAPPER}} .kek-testimonial-grid .kek-style-2 .kek-item:nth-child(4n+3), {{WRAPPER}} .kek-testimonial-grid .kek-style-2 .kek-item:nth-child(4n+4), {{WRAPPER}} .kek-testimonial-grid .kek-style-3 .kek-item:nth-child(5n+2) .kek-img-wrap .kek-main-img .kek-img, {{WRAPPER}} .kek-testimonial-grid .kek-style-3 .kek-item:nth-child(5n+3) .kek-img-wrap .kek-main-img .kek-img, {{WRAPPER}} .kek-testimonial-grid .kek-style-3 .kek-item:nth-child(5n+4) .kek-img-wrap .kek-main-img .kek-img, {{WRAPPER}} .kek-testimonial-grid .kek-style-3 .kek-item:nth-child(5n+5) .kek-img-wrap .kek-main-img .kek-img' => 'height: {{SIZE}}px;',
        ],
            'condition' => [
            'grid_style' => [ '2', '3' ],
        ],
        ...
        $this->add_responsive_control( 'secondary_image_width', [
            ...
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-style-2 .kek-item:nth-child(4n+2) .kek-img-wrap .kek-main-img, {{WRAPPER}} .kek-testimonial-grid .kek-style-2 .kek-item:nth-child(4n+3) .kek-img-wrap .kek-main-img, {{WRAPPER}} .kek-testimonial-grid .kek-style-2 .kek-item:nth-child(4n+4) .kek-img-wrap .kek-main-img' => 'width: {{SIZE}}px;',
        ],
            'condition' => [
            'grid_style' => [ '2' ],
        ],
        ...
        $this->add_control( 'author_name', [
            'label'       => __( 'Author Name', 'kws-elementor-kit' ) . CFTKEK_NC,
            'type'        => Controls_Manager::TEXT,
            'default'     => '',
            'label_block' => false,
            'dynamic' => [
        ...
        /* Controll for adding Image */
        $this->add_control( 'speaker_image', [
            'label'       => __( 'Choose Author Image', 'kws-elementor-kit' ) . CFTKEK_NC,
        ...
        $this->add_responsive_control( 'readmore_icon_indent', [
            ...
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-button-icon-align-right' => ( is_rtl() ? 'margin-right: {{SIZE}}{{UNIT}};' : 'margin-left: {{SIZE}}{{UNIT}};' ),
            '{{WRAPPER}} .kek-testimonial-grid .kek-button-icon-align-left'  => ( is_rtl() ? 'margin-left: {{SIZE}}{{UNIT}};' : 'margin-right: {{SIZE}}{{UNIT}};' ),
        ],
        ] );
        $this->end_controls_section();
        //Style
        ...
        $this->add_responsive_control( 'content_padding', [
            ...
            'size_units' => [ 'px', 'em', '%' ],
            'selectors'  => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ],
        ] );
        ...
        $this->add_group_control( Group_Control_Background::get_type(), [
            ...
            'selector' => '{{WRAPPER}} .kek-testimonial-grid .kek-item',
        ] );
        ...
        $this->add_responsive_control( 'item_border_radius', [
            ...
            'size_units' => [ 'px', '%' ],
            'selectors'  => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ],
        ] );
        ...
        $this->add_group_control( Group_Control_Background::get_type(), [
            ...
            'selector' => '{{WRAPPER}} .kek-testimonial-grid .kek-item:hover',
        ] );
        $this->add_control( 'item_border_color_hover', [
            'label'     => esc_html__( 'Border Color', 'kws-elementor-kit' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item:hover' => 'border-color: {{VALUE}};',
        ],
            'condition' => [
            'item_border_border!' => '',
        ],
        ...
        $this->add_control( 'title_color', [
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-title a' => 'color: {{VALUE}};',
        ],
        ] );
        $this->add_control( 'title_hover_color', [
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-title a:hover' => 'color: {{VALUE}};',
        ],
        ] );
        $this->add_responsive_control( 'title_spacing', [
            ...
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
        ],
        ] );
        $this->add_group_control( Group_Control_Typography::get_type(), [
            'name'     => 'title_typography',
            'label'    => esc_html__( 'Typography', 'kws-elementor-kit' ),
            'selector' => '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-title',
        ] );
        $this->add_group_control( Group_Control_Typography::get_type(), [
            'name'      => 'secondary_title_typography',
            'label'     => esc_html__( 'Secondary Typography', 'kws-elementor-kit' ),
            'selector'  => '{{WRAPPER}} .kek-testimonial-grid .kek-style-2 .kek-item:nth-child(4n+2) .kek-title, {{WRAPPER}} .kek-testimonial-grid .kek-style-2 .kek-item:nth-child(4n+3) .kek-title, {{WRAPPER}} .kek-testimonial-grid .kek-style-2 .kek-item:nth-child(4n+4) .kek-title, {{WRAPPER}} .kek-testimonial-grid .kek-style-3 .kek-item:nth-child(5n+2) .kek-title, {{WRAPPER}} .kek-testimonial-grid .kek-style-3 .kek-item:nth-child(5n+3) .kek-title, {{WRAPPER}} .kek-testimonial-grid .kek-style-3 .kek-item:nth-child(5n+4) .kek-title, {{WRAPPER}} .kek-testimonial-grid .kek-style-3 .kek-item:nth-child(5n+5) .kek-title',
            'condition' => [
            'grid_style' => [ '2', '3' ],
        ],
        ] );
        ...
        $this->add_control( 'title_background', [
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-title a' => 'background-color: {{VALUE}};',
        ],
            'condition' => [
        ...
        $this->add_group_control( Group_Control_Text_Shadow::get_type(), [
            ...
            'selector'  => '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-title a',
            'condition' => [
            'title_advanced_style' => 'yes',
        ],
        ] );
        ...
        $this->add_responsive_control( 'title_border_radius', [
            ...
            'size_units' => [ 'px', '%' ],
            'selectors'  => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-title a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ],
            'condition'  => [
            'title_advanced_style' => 'yes',
        ],
        ...
        $this->add_responsive_control( 'title_text_padding', [
            ...
            'size_units' => [ 'px', 'em', '%' ],
            'selectors'  => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-title a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ],
            'condition'  => [
            'title_advanced_style' => 'yes',
        ],
        ...
        $this->add_control( 'text_color', [
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-text-wrap .kek-text' => 'color: {{VALUE}};',
        ],
        ] );
        $this->add_group_control( Group_Control_Typography::get_type(), [
            'name'     => 'text_typography',
            'label'    => esc_html__( 'Typography', 'kws-elementor-kit' ),
            'selector' => '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-text-wrap .kek-text',
        ] );
        $this->add_responsive_control( 'text_margin', [
            ...
            'size_units' => [ 'px', 'em', '%' ],
            'selectors'  => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-text-wrap .kek-text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ],
        ] );
        $this->end_controls_section();
        ...
        $this->add_control( 'meta_color', [
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-meta .kek-blog-author a, {{WRAPPER}} .kek-testimonial-grid .kek-item .kek-meta' => 'color: {{VALUE}};',
        ],
        ] );
        $this->add_control( 'meta_hover_color', [
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-meta .kek-blog-author a:hover' => 'color: {{VALUE}};',
        ],
        ] );
        $this->add_responsive_control( 'meta_spacing', [
            ...
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-meta .kek-separator' => 'margin: 0 {{SIZE}}{{UNIT}};',
        ],
        ] );
        $this->add_group_control( Group_Control_Typography::get_type(), [
            'name'     => 'meta_typography',
            'label'    => esc_html__( 'Typography', 'kws-elementor-kit' ),
            'selector' => '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-meta',
        ] );
        $this->end_controls_section();
        ...
        $this->add_responsive_control( 'category_spacing', [
            ...
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-category' => 'margin-bottom: {{SIZE}}{{UNIT}};',
        ],
        ] );
        ...
        $this->add_control( 'category_color', [
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-category a' => 'color: {{VALUE}};',
        ],
        ] );
        $this->add_group_control( Group_Control_Background::get_type(), [
            'name'     => 'category_background',
            'selector' => '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-category a',
        ] );
        $this->add_group_control( Group_Control_Border::get_type(), [
        ...
        $this->add_responsive_control( 'category_border_radius', [
            ...
            'size_units' => [ 'px', '%' ],
            'selectors'  => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-category a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ],
        ] );
        $this->add_responsive_control( 'category_padding', [
            ...
            'size_units' => [ 'px', 'em', '%' ],
            'selectors'  => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-category a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ],
        ] );
        $this->add_responsive_control( 'category_margin', [
            ...
            'size_units' => [ 'px', 'em', '%' ],
            'selectors'  => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-category' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ],
        ] );
        $this->add_responsive_control( 'category_spacing_between', [
            ...
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-category a+a' => 'margin-left: {{SIZE}}{{UNIT}};',
        ],
        ] );
        $this->add_group_control( Group_Control_Box_Shadow::get_type(), [
        ...
        $this->add_control( 'category_hover_color', [
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-category a:hover' => 'color: {{VALUE}};',
        ],
        ] );
        $this->add_group_control( Group_Control_Background::get_type(), [
            'name'     => 'category_hover_background',
            'selector' => '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-category a:hover',
        ] );
        $this->add_control( 'category_hover_border_color', [
            ...
            'selectors' => [
            '{{WRAPPER}} .kek-testimonial-grid .kek-item .kek-category a:hover' => 'border-color: {{VALUE}};',
        ],
        ] );
        $this->end_controls_tab();
        $this->end_controls_tabs();
    ...
    public function render_post_grid_item( $post_id, $image_size, $excerpt_length )
    {
        ...
        ?>
								<p class="kek-text-author-name">
                                <?php 
                                      echo $settings['author_name'];
                                      //echo (elementor.imagesManager.getImageUrl( speaker_image ));
                                      echo $settings['speaker_image'][0];  
        ?></p>
                            </div>
    ...
    protected function render()
    {
        ...
        ?>
            ...
            <div class="kek-testimonial-grid">
				<div <?php 
