...
(function($) {
    "use strict";
    $.kekNewsTicker = function(element, options) {
        ...
        ticker._label            = ticker._element.children(".kek-news-ticker-label"),
        ticker._news             = ticker._element.children(".kek-news-ticker-content"),
        ticker._ul               = ticker._news.children("ul"),
        ticker._li               = ticker._ul.children("li"),
        ticker._controls         = ticker._element.children(".kek-news-ticker-controls"),
        ticker._prev             = ticker._controls.find(".kek-news-ticker-prev").parent(),
        ticker._action           = ticker._controls.find(".kek-news-ticker-action").parent(),
        ticker._next             = ticker._controls.find(".kek-news-ticker-next").parent();
        ...
        ticker.init = function() {
            ...
            //ticker._element.append('<div class="kek-breaking-loading"></div>');
            //window.onload = function(){

            	//ticker._element.find('.kek-breaking-loading').hide();

	            //adding effect type class
	            ticker._element.addClass('kek-effect-'+ticker.settings.effect+' kek-direction-'+ticker.settings.direction);
	            ...
	            if (!ticker.settings.autoPlay)
	                ticker._action.find('span').removeClass('kek-news-ticker-pause').addClass('kek-news-ticker-play');
	            else
	                ticker._action.find('span').removeClass('kek-news-ticker-play').addClass('kek-news-ticker-pause');


	            ticker._element.on('mouseleave', function(e){                
	                var activePosition = $(document.elementFromPoint(e.clientX, e.clientY)).parents('.kek-breaking-news')[0];
	            ...
	            ticker._action.on('click', function(){
	                if (ticker._controlsIsActive){
	                    if (ticker._action.find('span').hasClass('kek-news-ticker-pause'))
	                    {
	                        ticker._action.find('span').removeClass('kek-news-ticker-pause').addClass('kek-news-ticker-play');
	                        ticker.stop();
	                    }
    ...
    $.fn.kekNewsTicker = function(options) {

        return this.each(function() {
            if (undefined == $(this).data('kekNewsTicker')) {
                var ticker = new $.kekNewsTicker(this, options);
                $(this).data('kekNewsTicker', ticker);
            }
        });
...
(function ($, elementor) {
    ...
    var widgetAlexCarousel = function ($scope, $) {
        ...
        var $carousel = $scope.find('.kek-alex-carousel');
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-alex-carousel.default', widgetAlexCarousel);
    });
...
(function ($, elementor) {
    ...
    var widgetCategoryCarousel = function ($scope, $) {
        ...
        var $carousel = $scope.find('.kek-category-carousel');
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-category-carousel.default', widgetCategoryCarousel);
    });
...
(function($, elementor) {
    ...
    var widgetPlutoCarousel = function($scope, $) {

        var $carousel = $scope.find('.kek-pluto-carousel');
    ...
    jQuery(window).on('elementor/frontend/init', function() {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-pluto-carousel.default', widgetPlutoCarousel);
    });
...
(function ($, elementor) {
    ...
    var widgetJupiterCarousel = function ($scope, $) {

        var $carousel = $scope.find('.kek-jupiter-carousel');
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-jupiter-carousel.default', widgetJupiterCarousel);
    });
...
(function ($, elementor) {
    ...
    var widgetMapleCarousel = function ($scope, $) {
        ...
        var $carousel = $scope.find('.kek-maple-carousel');
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-maple-carousel.default', widgetMapleCarousel);
    });
...
(function ($, elementor) {
    ...
    var widgetRambleCarousel = function ($scope, $) {
        ...
        var $carousel = $scope.find('.kek-ramble-carousel');
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-ramble-carousel.default', widgetRambleCarousel);
    });
...
(function($, elementor) {
    ...
    var widgetAliceCarousel = function($scope, $) {
        ...
        var $carousel = $scope.find('.kek-alice-carousel');
    ...
    jQuery(window).on('elementor/frontend/init', function() {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-alice-carousel.default', widgetAliceCarousel);
    });
...
(function ($, elementor) {
    ...
    var widgetKalonCarousel = function ($scope, $) {
        ...
        var $carousel = $scope.find('.kek-kalon-carousel');
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-kalon-carousel.default', widgetKalonCarousel);
    });
...
(function ($, elementor) {
    ...
    var widgetMercurySlider = function ($scope, $) {

        var $carousel = $scope.find('.kek-mercury-slider');
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-mercury-slider.default', widgetMercurySlider);
    });
...
(function ($, elementor) {
    ...
    var widgetAndromedaCarousel = function ($scope, $) {

        var $carousel = $scope.find('.kek-andromeda-carousel');
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-andromeda-carousel.default', widgetAndromedaCarousel);
    });
...
(function ($, elementor) {
    ...
    var widgetBuzzListCarousel = function ($scope, $) {
        ...
        var $carousel = $scope.find('.kek-buzz-list-carousel');
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-buzz-list-carousel.default', widgetBuzzListCarousel);
    });
...
(function ($, elementor) {
    ...
    var widgetOptickSlider = function ($scope, $) {
        ...
        var $carousel = $scope.find('.kek-optick-slider');
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-optick-slider.default', widgetOptickSlider);
    });

}(jQuery, window.elementorFrontend));
; (function ($) {
    $(window).on("elementor/frontend/init", function () {
        elementorFrontend.hooks.addAction("frontend/element_ready/kek-holux-tabs.default", function (scope) {
            scope.find('.kws-elementor-kit-holux-tabs-wrap').each(function () {
                var element = $(this)[0];
                if (element) {
                    var settings = $(this).data('settings');
                    var tabs = $(this).find('.post-tab-option');
                    var tabs_header = $(this).find('.kek-holux-tabs-header-tabs')
                    var item = $(this).find('.kek-holux-tabs');
                    tabs.on('click', function (e) {
                        var data = $(this).data('settings');
                        tabs_header.find('li').removeClass('kek-holux-tabs-active');
                        $(this).parent().addClass('kek-holux-tabs-active');
                        e.preventDefault();
                        $.ajax({
                            url: KwsElementorKitConfig.ajaxurl,
                            data: {
                                action: "kek_holux_tabs",
                                settings: settings,
                                data: data,
                            },
                            type: "POST",
...
; (function ($) {
    $(window).on("elementor/frontend/init", function () {
        elementorFrontend.hooks.addAction("frontend/element_ready/kek-forbes-tabs.default", function (scope) {

            scope.find('.kek-forbes-tabs').each(function () {
                // alert("hmm");
                var element = $(this)[0];

                if (element) {
                    var showHide = $(this).data('show-hide');
                    var tabs = $(this).find('.kek-option');
                    var responsive_tabs = $(this).find('.kek-filter-item');
                    var tabs_header = $(this).find('.kek-forbes-tabs-header-wrap')
                    var item_wrapper = $(this).find('.kek-forbes-tabs-grid-wrapper');
                    var settings = item_wrapper.data('settings');
                    var paged = $(this).find('.kek-pagination-btn');
                    // console.log(paged);

                    tabs.on('click', function (e) {
                        var slug = $(this).data('slug');
                        tabs_header.find('li').removeClass('kek-forbes-tabs-active');
                        $(this).parent().addClass('kek-forbes-tabs-active');
                        e.preventDefault();
                        $.ajax({
                            url: KwsElementorKitConfig.ajaxurl,
                            data: {
                                action: "kek_forbes_tabs",
                                settings: settings,
                                data: slug,
                                showHide: showHide
                            },
...
;(function($) {
    ...
    function gernerateHtml(type, className, text,) {
      return [
        '<div class="kek-newsletter-' + type + ' ' + className + '">',
          '<div class="kek-alert-box">',
              text,
          '</div>',
        '</div>'
      ].join('');
    ...
    $.alert.hide = function() {
      $('.kek-newsletter-alert').slideUp(800).remove();
    };
...
( function( $, elementor ) {
    ...
    var widgetMailChimp = function( $scope, $ ) {
        ...
        var $mailChimp = $scope.find('.kek-newsletter');
            
        if ( ! $mailChimp.length ) {
            return;
        }
 
        var langStr = window.KwsElementorKitConfig.mailchimp;
    ...
    jQuery(window).on('elementor/frontend/init', function() {
        elementorFrontend.hooks.addAction( 'frontend/element_ready/kek-newsletter.default', widgetMailChimp );
    });
...
(function ($, elementor) {
    ...
    var widgetHanselSlider = function ($scope, $) {
        ...
        var $carousel = $scope.find('.kek-hansel-slider');
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-hansel-slider.default', widgetHanselSlider);
    });
...
(function ($, elementor) {
    ...
    var widgetPixinaCarousel = function ($scope, $) {
        ...
        var $carousel = $scope.find('.kek-pixina-carousel');
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-pixina-carousel.default', widgetPixinaCarousel);
    });
...
(function ($, elementor) {
    ...
    var widgetWixerCarousel = function ($scope, $) {
        ...
        var $carousel = $scope.find('.kek-wixer-carousel');
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-wixer-carousel.default', widgetWixerCarousel);
    });
 ...
 */
 ...
 (function($, elementor) {
    ...
    var widgetPostCalendar = function($scope, $) {
        var $CalendarPost = $scope.find('.kek-post-calendar'),
            $HeadingDate = $scope.find('.kek-date-wrapper'),
        ...
        var today = jQuery('.kek-post-calendar .kek-current-date').val(),
        selector  = jQuery('.kek-post-calendar .kek-calendar-table td a');
        selector.parent().addClass('kek-has-post');

        showPost(today);

        $($CalendarPost).on('click', '.kek-click-day', function(e) {
            //e.preventDefault();

            jQuery('.kek-post-calendar .kek-calendar-table td').removeClass('kek-selected');
            jQuery(this).parent().parent().addClass('kek-selected');
        ...
        function showPost(filterDate) {
            jQuery.ajax({
                ...
                type: 'post',
                data: {
                    action: 'kws_elementor_kit_calendar_post',
                    filterDate: filterDate,
                },
                success: function(html) {
                    $($CalendarPost).find('.kek-post-calendar-list').empty();
                    $($CalendarPost).find('.kek-post-calendar-list').append(html).fadeIn(5000);
                },
                error: function() {
                    console.log("Error");
                }
        ...
        function kek_get_month(getMonth) {
            jQuery.ajax({
                url: $CalendarPost.attr('action'),
                type: 'post',
                data: {
                    action: 'kws_elementor_kit_calendar',
                    getMonth: getMonth,
                    showPostsList: $settings.showPostList,
                },
                success: function(html) {
                    setTimeout(function() {
                        $($CalendarPost).find('.kek-get-calendar').html(html);
                        $($CalendarPost).find('.kek-calendar-table td a').parent().parent().addClass('kek-has-post');
                    }, 500);
                },
                error: function(html) {
                    console.log("Error");
        ...
        var d = new Date(),
            ...
            kek_get_month(getMonth);
            $($CalendarPost).on('change', '.kek-month-dropdown', function() {
        ...
        jQuery(window).on('elementor/frontend/init', function() {
            elementorFrontend.hooks.addAction('frontend/element_ready/kek-post-calendar.default', widgetPostCalendar);
        });
    }(jQuery, window.elementorFrontend));
...
(function($, elementor) {
    ...
    var widgetVenusCarousel = function($scope, $) {
        ...
        var $carousel = $scope.find('.kek-grove-timeline');
    ...
    jQuery(window).on('elementor/frontend/init', function() {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-grove-timeline.default', widgetVenusCarousel);
    });
...
(function ($, elementor) {
    ...
    var widgetNoxeSlider = function ($scope, $) {
        ...
        var $carousel = $scope.find('.kek-noxe-slider');
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-noxe-slider.default', widgetNoxeSlider);
    });
...
(function ($, elementor) {
    ...
    var widgetSkideSlider = function ($scope, $) {
        ...
        var $carousel = $scope.find('.kek-skide-slider');
        if (!$carousel.length) {
            return;
        }
        ...
        async function initSwiper() {
            ...
            var $mainWrapper = $scope.find('.kek-skide-slider-wrap'),
                $thumbs = $mainWrapper.find('.kek-skide-thumbs');
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-skide-slider.default', widgetSkideSlider);
    });
...
; (function ($) {
    $(window).on("elementor/frontend/init", function () {
        elementorFrontend.hooks.addAction("frontend/element_ready/kek-social-count.default", function (scope) {
            scope.find('.kek-social-count').each(function () {
                var element = $(this)[0];
...
(function ($, elementor) {
	...
	var widgetCamuxSlider = function ($scope, $) {
		...
		var $carousel = $scope.find('.kek-camux-slider');
        if (!$carousel.length) {
            return;
        }
        ...
        async function initSwiper() {
            ...
            var $mainWrapper = $scope.find('.kek-camux-slider-wrap'),
            $thumbs          = $mainWrapper.find('.kek-camux-thumbs');
	...
	jQuery(window).on('elementor/frontend/init', function () {
		elementorFrontend.hooks.addAction('frontend/element_ready/kek-camux-slider.default', widgetCamuxSlider);
	});
...
(function($, elementor) {
    ...
    var widgetCrystalSlider = function($scope, $) {
        ...
        var $carousel = $scope.find('.kek-crystal-slider');
    ...
    jQuery(window).on('elementor/frontend/init', function() {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-crystal-slider.default', widgetCrystalSlider);
    });
...
(function ($, elementor) {
	...
	var widgetReadingProgress = function ($scope, $) {
		...
		var $scrolline = $scope.find('.kek-reading-progress'),
			$settings = $scrolline.data('settings');

		if (!$scrolline.length) {
			return;
		}
		if ($('.kek-reading-progress-wrap')) {
			$('.kek-reading-progress-wrap').remove();
		}
		...
		jQuery.scrolline($settings);
		 ...
		 if ($("body.admin-bar").length && $settings.position == 'top') {
		 	$('.kek-reading-progress-wrap').css('margin-top', 32);
		 }

	};

	jQuery(window).on('elementor/frontend/init', function () {
		elementorFrontend.hooks.addAction('frontend/element_ready/kek-reading-progress.default', widgetReadingProgress);
	});
...
(function ($, elementor) {
    ...
    var widgetAtlasSlider = function ($scope, $) {
        ...
        var $slider = $scope.find('.kek-atlas-slider'),
        ...
        async function initSwiper() {
            ...
            var $thumbs = $slider.find('.kek-atlas-slider-playlist');
            var $preview = $slider.find('.kek-atlas-slider-preview');
            ...
            var stopVideos = function () {
                $slider.find('.kek-atlas-video-wrap').css('z-index', -1);
                var videos = $slider.find('.kek-atlas-video-iframe');
                Array.prototype.forEach.call(videos, function (video) {
                    var src = video.src;
                    video.src = src.replace("?autoplay=1", "");
                    $slider.find('.kek-atlas-video-iframe').prop("src", "");
                });
            };

            $slider.find('.kek-atlas-video-trigger').on('click', function () {
                var videoURL = $(this).data('src').split('?')[0],
                    sliderWrapper = $slider.find('.swiper-slide-active .kek-atlas-image-wrap');

                sliderWrapper.find('.kek-atlas-video-iframe').attr("src", videoURL + "?autoplay=1");
                sliderWrapper.find('.kek-atlas-video-wrap').css('z-index', 10);
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/kek-atlas-slider.default', widgetAtlasSlider);
    });
...
(function ($, elementor) {
	...
	var widgetReadingProgressCircle = function ($scope, $) {
		...
		var $readingProgress = $scope.find('#kek-reading-progress-circle'),
		...
		var scrollPercentage = () => {
			var scrollProgress = document.getElementById("kek-reading-progress-circle");
			var progressValue = document.getElementById("kek-reading-progress-circle-value");
	...
	jQuery(window).on('elementor/frontend/init', function () {
		elementorFrontend.hooks.addAction('frontend/element_ready/kek-reading-progress-circle.default', widgetReadingProgressCircle);
	});
...
// 	let scrollProgress = document.getElementById("kek-reading-progress-circle");
// 	let progressValue = document.getElementById("kek-reading-progress-circle-value");
