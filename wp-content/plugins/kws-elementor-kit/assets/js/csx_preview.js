...
var EleCustomSkinPreview = elementorModules.frontend.handlers.Base.extend({
  ...
  writePreview: function writePreview(){
    ...
    jQuery('#csx-preview .elementor-element-overlay').remove();
    jQuery('#csx-preview .elementor-element-edit-mode').removeClass( "elementor-element-edit-mode" );
    jQuery('#csx-preview .elementor-element-editable').removeClass( "elementor-element-editable" );
  },
