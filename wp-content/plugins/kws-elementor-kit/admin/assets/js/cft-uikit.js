/*! cftUIkit 3.7.2 | https://www.getuikit.com | (c) 2014 - 2021 YOOtheme | MIT License */

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
    typeof define === 'function' && define.amd ? define('uikit', factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.cftUIkit = factory());
    ...
    var parseCssVar = memoize(function (name) {
        /* usage in css: .cft-name:before { content:"xyz" } */

        var element = append(document.documentElement, document.createElement('div'));

        addClass(element, ("cft-" + name));
    ...
    function getCssVar(name) {
        return !isIE
            ? getStyles(document.documentElement).getPropertyValue(("--cft-" + name))
            : parseCssVar(name);
    }
    ...
    function transition(element, props, duration, timing) {
        ...
        return Promise$1.all(toNodes(element).map(function (element) { return new Promise$1(function (resolve, reject) {
                ...
                once(element, 'transitionend transitioncanceled', function (ref) {
                    ...
                    clearTimeout(timer);
                    removeClass(element, 'cft-transition');
                    css(element, {
                        transitionProperty: '',
                        transitionDuration: '',
                ...
                addClass(element, 'cft-transition');
                css(element, assign({
    ...
    var Transition = {
        ...
        inProgress: function(element) {
            return hasClass(element, 'cft-transition');
        }

    };

    var animationPrefix = 'cft-animation-';
    ...
    function animate$1(element, animation, duration, origin, out) {
        ...
        return Promise$1.all(toNodes(element).map(function (element) { return new Promise$1(function (resolve, reject) {
                ...
                if (startsWith(animation, animationPrefix)) {
                    origin && addClass(element, ("cft-transform-origin-" + origin));
    ...
    */
    ...
    function globalAPI (cftUIkit) {

        var DATA = cftUIkit.data;

        cftUIkit.use = function (plugin) {
        ...
        cftUIkit.mixin = function (mixin, component) {
            component = (isString(component) ? cftUIkit.component(component) : component) || this;
            component.options = mergeOptions(component.options, mixin);
        };

        cftUIkit.extend = function (options) {

            options = options || {};

            var Super = this;
            var Sub = function cftUIkitComponent(options) {
                this._init(options);
            };
        ...
        cftUIkit.update = function (element, e) {
        ...
        var container;
        Object.defineProperty(cftUIkit, 'container', {
    ...
    function hooksAPI (cftUIkit) {

        cftUIkit.prototype._callHook = function (hook) {
            var this$1 = this;
        ...
        cftUIkit.prototype._callConnected = function () {
        ...
        cftUIkit.prototype._callDisconnected = function () {
        ...
        cftUIkit.prototype._callUpdate = function (e) {
            var this$1 = this;
        ...
        cftUIkit.prototype._callWatches = function () {
            var this$1 = this;
    ...
    function stateAPI (cftUIkit) {

        var uid = 0;

        cftUIkit.prototype._init = function (options) {
        ...
        cftUIkit.prototype._initData = function () {
        ...
        cftUIkit.prototype._initMethods = function () {
        ...
        cftUIkit.prototype._initComputeds = function () {
        ...
        cftUIkit.prototype._initProps = function (props) {
        ...
        cftUIkit.prototype._initEvents = function () {
            var this$1 = this;
        ...
        cftUIkit.prototype._unbindEvents = function () {
            this._events.forEach(function (unbind) { return unbind(); });
            delete this._events;
        };

        cftUIkit.prototype._initObservers = function () {
            this._observers = [
        ...
        cftUIkit.prototype._disconnectObservers = function () {
    ...
    function instanceAPI (cftUIkit) {

        var DATA = cftUIkit.data;

        cftUIkit.prototype.$create = function (component, element, data) {
            return cftUIkit[component](element, data);
        };

        cftUIkit.prototype.$mount = function (el) {
        ...
        cftUIkit.prototype.$reset = function () {
            this._callDisconnected();
            this._callConnected();
        };

        cftUIkit.prototype.$destroy = function (removeEl) {
        ...
        cftUIkit.prototype.$emit = function (e) {
            this._callUpdate(e);
        };

        cftUIkit.prototype.$update = function (element, e) {
            if ( element === void 0 ) element = this.$el;

            cftUIkit.update(element, e);
        };

        cftUIkit.prototype.$getComponent = cftUIkit.getComponent;

        var componentName = memoize(function (name) { return cftUIkit.prefix + hyphenate(name); });
        Object.defineProperties(cftUIkit.prototype, {

            $container: Object.getOwnPropertyDescriptor(cftUIkit, 'container'),
    ...
    function componentAPI (cftUIkit) {

        var DATA = cftUIkit.data;

        var components = {};

        cftUIkit.component = function (name, options) {
            ...
            if (!options) {
                ...
                if (isPlainObject(components[name])) {
                    components[name] = cftUIkit.extend(components[name]);
                }
            ...
            cftUIkit[name] = function (element, data) {
                var i = arguments.length, argsArray = Array(i);
                while ( i-- ) argsArray[i] = arguments[i];


                var component = cftUIkit.component(name);
                ...
                function init(element) {
                    ...
                    var instance = cftUIkit.getComponent(element, name);
            ...
            if (opt.install) {
                opt.install(cftUIkit, opt, name);
            }

            if (cftUIkit._initialized && !opt.functional) {
                fastdom.read(function () { return cftUIkit[name](("[cft-" + id + "],[data-cft-" + id + "]")); });
            }

            return components[name] = isPlainObject(options) ? opt : options;
        };

        cftUIkit.getComponents = function (element) { return element && element[DATA] || {}; };
        cftUIkit.getComponent = function (element, name) { return cftUIkit.getComponents(element)[name]; };

        cftUIkit.connect = function (node) {
        ...
        cftUIkit.disconnect = function (node) {
            for (var name in node[DATA]) {
    ...
    var getComponentName = memoize(function (attribute) {
        return startsWith(attribute, 'cft-') || startsWith(attribute, 'data-cft-')
            ? camelize(attribute.replace('data-cft-', '').replace('cft-', ''))
            : false;
    });

    var cftUIkit = function (options) {
        this._init(options);
    };

    cftUIkit.util = util;
    cftUIkit.data = '__uikit__';
    cftUIkit.prefix = 'cft-';
    cftUIkit.options = {};
    cftUIkit.version = '3.7.2';

    globalAPI(cftUIkit);
    hooksAPI(cftUIkit);
    stateAPI(cftUIkit);
    componentAPI(cftUIkit);
    instanceAPI(cftUIkit);

    function Core (cftUIkit) {
        ...
        on(document, 'animationstart', function (ref) {
            ...
            if ((css(target, 'animationName') || '').match(/^cft-.*(left|right)/)) {
    ...
    function boot (cftUIkit) {

        var connect = cftUIkit.connect;
        var disconnect = cftUIkit.disconnect;
        ...
        function applyAttributeMutation(ref) {
            ...
            if (!name || !(name in cftUIkit)) {
                return;
            }

            if (hasAttr(target, attributeName)) {
                cftUIkit[name](target);
                return;
            }

            var component = cftUIkit.getComponent(target, name);
    ...
    var Togglable = {
        ...
        data: {
            ...
            origin: false,
            transition: 'linear',
            clsEnter: 'cft-togglabe-enter',
            clsLeave: 'cft-togglabe-leave',
    ...
    var Accordion = {
        ...
        data: {
            ...
            multiple: false,
            clsOpen: 'cft-open',
            toggle: '> .cft-accordion-title',
            content: '> .cft-accordion-content',
            transition: 'ease',
            offset: 0
        },
    ...
    var drop = {
        ...
        computed: {
            ...
            clsDrop: function(ref) {
                ...
                return clsDrop || ("cft-" + (this.$options.name));
            },
    ...
    var Margin = {
        ...
        data: {
            margin: 'cft-margin-small-top',
            firstColumn: 'cft-first-column'
        },
    ...
    var grid = {
        ...
        data: {
            margin: 'cft-grid-margin',
            clsStack: 'cft-grid-stack',
            masonry: false,
            parallax: 0
        },

        connected: function() {
            this.masonry && addClass(this.$el, 'cft-flex-top cft-flex-wrap-top');
        },
    ...
    function applyAnimation(el) {
        ...
        if (length) {
            el.style.setProperty('--cft-animation-stroke', length);
        }
    ...
    var Slidenav = {
        ...
        computed: {
            ...
            icon: function(ref, $el) {
                ...
                return hasClass($el, 'cft-slidenav-large')
                    ? (icon + "-large")
                    : icon;
            }
    ...
    var Search = {
        ...
        computed: {
            ...
            icon: function(ref, $el) {
                ...
                return hasClass($el, 'cft-search-icon') && parents($el, '.cft-search-large').length
                    ? 'search-large'
                    : parents($el, '.cft-search-navbar').length
                        ? 'search-navbar'
                        : icon;
            }
    ...
    var Close = {
        ...
        computed: {
            ...
            icon: function() {
                return ("close-" + (hasClass(this.$el, 'cft-close-large') ? 'large' : 'icon'));
            }
    ...
    var parsed = {};
    function install$3(cftUIkit) {
        cftUIkit.icon.add = function (name, svg) {
            var obj;
            ...
            if (cftUIkit._initialized) {
                apply$1(document.body, function (el) { return each(cftUIkit.getComponents(el), function (cmp) {
    ...
    var leader = {
        ...
        data: {
            fill: '',
            clsWrapper: 'cft-leader-fill',
            clsHide: 'cft-leader-hide',
            attrFill: 'data-fill'
        },
    ...
    var modal = {
        ...
        data: {
            clsPage: 'cft-modal-page',
            selPanel: '.cft-modal-dialog',
            selClose: '.cft-modal-close, .cft-modal-close-default, .cft-modal-close-outside, .cft-modal-close-full'
        },
        ...
        events: [

            {
                ...
                handler: function() {
                    ...
                    if (hasClass(this.panel, 'cft-margin-auto-vertical')) {
                        addClass(this.$el, 'cft-flex');
                    } else {
    ...
    function install$2(ref) {
        ...
        modal.dialog = function (content, options) {
            ...
            var dialog = modal(
                ("<div class=\"cft-modal\"> <div class=\"cft-modal-dialog\">" + content + "</div> </div>"),
                options
            );
        ...
        modal.alert = function (message, options) {
            return openDialog(
                function (ref) {
                    ...
                    return ("<div class=\"cft-modal-body\">" + (isString(message) ? message : html(message)) + "</div> <div class=\"cft-modal-footer cft-text-right\"> <button class=\"cft-button cft-button-primary cft-modal-close\" autofocus>" + (labels.ok) + "</button> </div>");
            },
                options,
        ...
        modal.confirm = function (message, options) {
            return openDialog(
                function (ref) {
                    ...
                    return ("<form> <div class=\"cft-modal-body\">" + (isString(message) ? message : html(message)) + "</div> <div class=\"cft-modal-footer cft-text-right\"> <button class=\"cft-button cft-button-default cft-modal-close\" type=\"button\">" + (labels.cancel) + "</button> <button class=\"cft-button cft-button-primary\" autofocus>" + (labels.ok) + "</button> </div> </form>");
            },
                options,
        ...
        modal.prompt = function (message, value, options) {
            return openDialog(
                function (ref) {
                    ...
                    return ("<form class=\"cft-form-stacked\"> <div class=\"cft-modal-body\"> <label>" + (isString(message) ? message : html(message)) + "</label> <input class=\"cft-input\" value=\"" + (value || '') + "\" autofocus> </div> <div class=\"cft-modal-footer cft-text-right\"> <button class=\"cft-button cft-button-default cft-modal-close\" type=\"button\">" + (labels.cancel) + "</button> <button class=\"cft-button cft-button-primary\">" + (labels.ok) + "</button> </div> </form>");
            },
                options,
    ...
    var navItem = '.cft-navbar-nav > li > a, .cft-navbar-item, .cft-navbar-toggle';
        ...
        computed: {
            ...
            dropbar: {
                ...
                get: function(ref) {
                    ...
                    dropbar = this._dropbar || query(dropbar, this.$el) || $('+ .cft-navbar-dropbar', this.$el);
                ...
                watch: function(dropbar) {
                    addClass(dropbar, 'cft-navbar-dropbar');
                },
...

            {
                ...
                handler: function(_, ref) {
                    ...
                    if (this.dropbarMode === 'slide') {
                        addClass(this.dropbar, 'cft-navbar-dropbar-slide');
                    }
    ...
    var offcanvas = {
        ...
        data: {
            ...
            flip: false,
            overlay: false,
            clsPage: 'cft-offcanvas-page',
            clsContainer: 'cft-offcanvas-container',
            selPanel: '.cft-offcanvas-bar',
            clsFlip: 'cft-offcanvas-flip',
            clsContainerAnimation: 'cft-offcanvas-container-animation',
            clsSidebarAnimation: 'cft-offcanvas-bar-animation',
            clsMode: 'cft-offcanvas',
            clsOverlay: 'cft-offcanvas-overlay',
            selClose: '.cft-offcanvas-close',
            container: false
        },
    ...
    var overflowAuto = {
        ...
        data: {
            selContainer: '.cft-modal',
            selContent: '.cft-modal-dialog'
        },
    ...
    var responsive = {
        ...
        connected: function() {
            addClass(this.$el, 'cft-responsive-width');
        },
    ...
    var scrollspy = {
        ...
        data: function () { return ({
            ...
            repeat: false,
            delay: 0,
            inViewClass: 'cft-scrollspy-inview'
        }); },
...

            {
                ...
                read: function(data$1) {
                    ...
                    this.elements.forEach(function (el) {
                        ...
                        if (!el[stateKey]) {
                            el[stateKey] = {cls: data(el, 'cft-scrollspy-class') || this$1.cls};
                        }
        ...
        methods: {
            ...
            toggle: function(el, inview) {
                ...
                if (/\bcft-animation-/.test(state.cls)) {
                    state.off = once(el, 'animationcancel animationend', function () { return removeClasses(el, 'cft-animation-[\\w-]+'); }
                    );
                }
    ...
    var sticky = {
        ...
        data: {
            ...
            offset: 0,
            animation: '',
            clsActive: 'cft-active',
            clsInactive: '',
            clsFixed: 'cft-sticky-fixed',
            clsBelow: 'cft-sticky-below',
            selTarget: '',
            widthElement: false,
            showOnUp: false,
            targetOffset: false
        ...
        connected: function() {
            this.placeholder = $('+ .cft-sticky-placeholder', this.$el) || $('<div class="cft-sticky-placeholder"></div>');
            this.isFixed = false;
            this.isActive = false;
        },
    ...
    var Switcher = {
        ...
        data: {
            connect: '~.cft-switcher',
            toggle: '> * > :first-child',
            active: 0,
            swiping: true,
            cls: 'cft-active',
            attrItem: 'cft-switcher-item'
        },
        ...
        computed: {
            ...
            toggles: {
                ...
                get: function(ref, $el) {
                    ...
                    return $$(toggle, $el).filter(function (el) { return !matches(el, '.cft-disabled *, .cft-disabled, [disabled]'); });
                },
    ...
    var tab = {
        ...
        data: {
            media: 960,
            attrItem: 'cft-tab-item'
        },

        connected: function() {

            var cls = hasClass(this.$el, 'cft-tab-left')
                ? 'cft-tab-left'
                : hasClass(this.$el, 'cft-tab-right')
                    ? 'cft-tab-right'
                    : false;
    ...
    // register components
    each(components$1, function (component, name) { return cftUIkit.component(name, component); }
    );
    ...
    var clsLeave = 'cft-transition-leave';
    var clsEnter = 'cft-transition-enter';
    ...
    function fade(action, target, duration, stagger) {
        ...
        var enterFn = wrapIndexFn(function () {
            ...
            // Ensure cftUIkit updates have propagated
        ...
        methods: {
            ...
            updateNav: function() {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    toggleClass(el, 'cft-invisible', this$1.finite && (cmd === 'previous' && i === 0 || cmd === 'next' && i >= this$1.maxIndex));
                });
    ...
    var Slideshow = {
        ...
        data: {
            animation: 'slide',
            clsActivated: 'cft-transition-active',
    ...
    var LightboxPanel = {
        ...
        data: function () { return ({
            ...
            items: [],
            cls: 'cft-open',
            clsPage: 'cft-lightbox-page',
            selList: '.cft-lightbox-items',
            attrItem: 'cft-lightbox-item',
            selClose: '.cft-close-large',
            selCaption: '.cft-lightbox-caption',
            pauseOnHover: false,
            velocity: 2,
            Animations: Animations$1,
            template: "<div class=\"cft-lightbox cft-overflow-hidden\"> <ul class=\"cft-lightbox-items\"></ul> <div class=\"cft-lightbox-toolbar cft-position-top cft-text-right cft-transition-slide-top cft-transition-opaque\"> <button class=\"cft-lightbox-toolbar-icon cft-close-large\" type=\"button\" cft-close></button> </div> <a class=\"cft-lightbox-button cft-position-center-left cft-position-medium cft-transition-fade\" href cft-slidenav-previous cft-lightbox-item=\"previous\"></a> <a class=\"cft-lightbox-button cft-position-center-right cft-position-medium cft-transition-fade\" href cft-slidenav-next cft-lightbox-item=\"next\"></a> <div class=\"cft-lightbox-toolbar cft-lightbox-caption cft-position-bottom cft-text-center cft-transition-slide-bottom cft-transition-opaque\"></div> </div>"
        }); },
        ...
        events: [
...

            {
                ...
                handler: function(_, item) {
                    ...
                    this.setItem(item, '<span cft-spinner></span>');
        ...
        methods: {
            ...
            setError: function(item) {
                this.setItem(item, '<span cft-icon="icon: bolt; ratio: 2"></span>');
            },
            ...
            showControls: function() {
                ...
                addClass(this.$el, 'cft-active', 'cft-transition-active');

            },

            hideControls: function() {
                removeClass(this.$el, 'cft-active', 'cft-transition-active');
            }
    ...
    var lightbox = {
        ...
        events: [

            {
                ...
                delegate: function() {
                    return ((this.toggle) + ":not(.cft-disabled)");
                },
    ...
    function install$1(cftUIkit, Lightbox) {

        if (!cftUIkit.lightboxPanel) {
            cftUIkit.component('lightboxPanel', LightboxPanel);
        }

        assign(
            Lightbox.props,
            cftUIkit.component('lightboxPanel').options.props
        );
    ...
    var notification = {
        ...
        data: {
            ...
            group: null,
            pos: 'top-center',
            clsContainer: 'cft-notification',
            clsClose: 'cft-notification-close',
            clsMsg: 'cft-notification-message'
        },
        ...
        created: function() {
            ...
            this.$mount(append(container,
                ("<div class=\"" + (this.clsMsg) + (this.status ? (" " + (this.clsMsg) + "-" + (this.status)) : '') + "\"> <a href class=\"" + (this.clsClose) + "\" data-cft-close></a> <div>" + (this.message) + "</div> </div>")
            ));
    ...
    function install(cftUIkit) {
        cftUIkit.notification.closeAll = function (group, immediate) {
            apply$1(document.body, function (el) {
                var notification = cftUIkit.getComponent(el, 'notification');
    ...
    var slider = {
        ...
        data: {
            center: false,
            sets: false,
            attrItem: 'cft-slider-item',
            selList: '.cft-slider-items',
            selNav: '.cft-slider-nav',
            clsContainer: 'cft-slider-container',
    ...
    var slideshow = {
        ...
        data: {
            ...
            minHeight: false,
            maxHeight: false,
            selList: '.cft-slideshow-items',
            attrItem: 'cft-slideshow-item',
            selNav: '.cft-slideshow-nav',
    ...
    var sortable = {
        ...
        data: {
            group: false,
            threshold: 5,
            clsItem: 'cft-sortable-item',
            clsPlaceholder: 'cft-sortable-placeholder',
            clsDrag: 'cft-sortable-drag',
            clsDragState: 'cft-drag',
            clsBase: 'cft-sortable',
            clsNoDrag: 'cft-sortable-nodrag',
            clsEmpty: 'cft-sortable-empty',
            clsCustom: '',
            handle: false,
            pos: {}
        },
    ...
    var tooltip = {
        ...
        data: {
            ...
            title: '',
            delay: 0,
            animation: ['cft-animation-scale-up'],
            duration: 100,
            cls: 'cft-active',
            clsPos: 'cft-tooltip'
        },
    ...
    each(components, function (component, name) { return cftUIkit.component(name, component); }
    );
