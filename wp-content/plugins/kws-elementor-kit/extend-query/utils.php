<?php
/* KWS Extended Query - Utility Methods */

function keq_get_taxonomies( $args = array() ) {
	...
	// filter
	$taxonomies = apply_filters('keq/get_taxonomies', $taxonomies, $args);
	
	// return
	return $taxonomies;
}

function keq_get_taxonomy_labels( $taxonomies = array() ) {
	
	// default
	if( empty($taxonomies) ) {
		$taxonomies = keq_get_taxonomies();
	}
