...
trait Global_Swiper_Functions {
	...
	function render_header_attribute( $name ) {
		$id              = 'kek-' . $name . '-carousel-' . $this->get_id();
		...
		$this->add_render_attribute( 'carousel', 'class', [ 'kek-' . $name . '-carousel' ] );
		
		if ( 'arrows' == $settings['navigation'] ) {
			$this->add_render_attribute( 'carousel', 'class', 'kek-arrows-align-' . $settings['arrows_position'] );
		} elseif ( 'dots' == $settings['navigation'] ) {
			$this->add_render_attribute( 'carousel', 'class', 'kek-dots-align-' . $settings['dots_position'] );
		} elseif ( 'both' == $settings['navigation'] ) {
			$this->add_render_attribute( 'carousel', 'class', 'kek-arrows-dots-align-' . $settings['both_position'] );
		} elseif ( 'arrows-fraction' == $settings['navigation'] ) {
			$this->add_render_attribute( 'carousel', 'class', 'kek-arrows-dots-align-' . $settings['arrows_fraction_position'] );
		}
	...
	function render_navigation() {
		...
		if ( 'arrows' == $settings['navigation'] ) : ?>
			<div class="kek-position-z-index kek-position-<?php echo esc_html( $settings['arrows_position'] . $hide_arrow_on_mobile ); ?>">
				<div class="kek-arrows-container kek-slidenav-container">
					<a href="" class="kek-navigation-prev">
						<i class="kek-icon-arrow-left-<?php echo esc_html($settings['nav_arrows_icon']); ?>" aria-hidden="true"></i>
					</a>
					<a href="" class="kek-navigation-next">
						<i class="kek-icon-arrow-right-<?php echo esc_html($settings['nav_arrows_icon']); ?>" aria-hidden="true"></i>
					</a>
				</div>
			</div>
		<?php endif;
	...
	function render_pagination() {
		...
		if ( 'dots' == $settings['navigation'] or 'arrows-fraction' == $settings['navigation'] ) : ?>
			<div class="kek-position-z-index kek-position-<?php echo esc_html($settings['dots_position']); ?>">
		...
		<?php elseif ( 'progressbar' == $settings['navigation'] ) : ?>
			<div class="swiper-pagination kek-position-z-index kek-position-<?php echo esc_html($settings['progress_position']); ?>"></div>
		<?php endif;
	}
	...
	function render_both_navigation() {
		...
		?>
		<div class="kek-position-z-index kek-position-<?php echo esc_html($settings['both_position']); ?>">
	...
	function render_arrows_fraction() {
		...
		?>
		<div class="kek-position-z-index kek-position-<?php echo esc_html($settings['arrows_fraction_position']); ?>">
