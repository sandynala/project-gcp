...
namespace KwsElementorKit\Modules\SocialCount\Widgets;
...
class Social_Count extends Group_Control_Query {
	public function get_name() {
		return 'kek-social-count';
	}

	public function get_title() {
		return CFTKEK . esc_html__('Social Count', 'kws-elementor-kit');
	}

	public function get_icon() {
		return 'kek-widget-icon kek-icon-social-count';
	}
	...
	public function get_style_depends() {
		if ($this->kek_is_edit_mode()) {
			...
			return ['kws-elementor-kit-font', 'kek-social-count'];
		}
	}
	...
	public function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .kek-social-count' => ' grid-template-columns: repeat({{VALUE}}, 1fr);'
				],
				// 'condition' => [
				// 	'select_layout' => 'grid'
				// ]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .kek-social-count' => 'grid-gap: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'before'
			]
		);
		...
		$repeater->add_group_control(
			...
			[
				...
				'exclude' => ['image'],
				'selector'  => '{{WRAPPER}} .kek-social-count {{CURRENT_ITEM}}.kek-item',
			]
		);
		$repeater->add_control(
		...
		$repeater->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .kek-social-count {{CURRENT_ITEM}} .kek-icon span' => 'color: {{VALUE}};',
				],
			]
		);
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .kek-social-count {{CURRENT_ITEM}} .kek-icon span' => 'background: {{VALUE}};',
				],
			]
		);
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .kek-social-count {{CURRENT_ITEM}} .kek-icon span' => 'border-color: {{VALUE}};',
				],
			]
		);
		$repeater->add_control(
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .kek-social-count {{CURRENT_ITEM}} .kek-icon:hover span' => 'color:{{VALUE}}',
				],
			]
		);
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .kek-social-count {{CURRENT_ITEM}} .kek-icon:hover span' => 'background: {{VALUE}};',
				],
			]
		);
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .kek-social-count {{CURRENT_ITEM}} .kek-icon:hover span' => 'border-color: {{VALUE}};',
				],
			]
		);
		$repeater->add_control(
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .kek-social-count {{CURRENT_ITEM}} .kek-count .counter-value' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .kek-social-count {{CURRENT_ITEM}} .kek-meta' => 'color: {{VALUE}};',
				],
			]
		);
		$repeater->end_controls_tab();
		...
		$this->add_group_control(
			...
			[
				...
				'types'     => ['classic', 'gradient'],
				'exclude' => ['image'],
				'selector'  => '{{WRAPPER}} .kek-social-count .kek-item',
			]
		);
		$this->add_group_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units'            => ['px', '%', 'em'],
				'selectors'             => [
					'{{WRAPPER}} .kek-social-count .kek-item'    => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units'            => ['px', '%', 'em'],
				'selectors'             => [
					'{{WRAPPER}} .kek-social-count .kek-item'    => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
		...
		$this->add_group_control(
			...
			[
				...
				'types'     => ['classic', 'gradient'],
				'exclude' => ['image'],
				'selector'  => '{{WRAPPER}} .kek-social-count .kek-item:hover',
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .kek-social-count .kek-icon span' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label'     => esc_html__('Background', 'kws-elementor-kit-pro'),
				'types'     => ['classic', 'gradient'],
				'selector'  => '{{WRAPPER}} .kek-social-count .kek-icon span',
			]
		);
		$this->add_group_control(
			Group_Control_Border::get_type(),
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units'            => ['px', '%', 'em'],
				'selectors'             => [
					'{{WRAPPER}} .kek-social-count .kek-icon span '    => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units'            => ['px', '%', 'em'],
				'selectors'             => [
					'{{WRAPPER}} .kek-social-count .kek-icon span '    => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .kek-social-count .kek-icon span i' => 'font-size: {{SIZE}}{{UNIT}};',
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .kek-social-count .kek-icon' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'select_style' => ''
				]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .kek-social-count .kek-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .kek-social-count .kek-icon span:hover' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label'     => esc_html__('Background', 'kws-elementor-kit-pro'),
				'types'     => ['classic', 'gradient'],
				'selector'  => '{{WRAPPER}} .kek-social-count .kek-icon span:hover',
			]
		);
		$this->add_control(
			'icon_h_border_color',
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .kek-social-count .kek-icon span:hover' => 'border-color: {{VALUE}}',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .kek-social-count .kek-count .counter-value' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .kek-social-count .kek-count .counter-value',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .kek-social-count .kek-count' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				]
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .kek-social-count .kek-meta' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label'     => esc_html__('Typography', 'kws-elementor-kit-pro'),
				'selector'  => '{{WRAPPER}} .kek-social-count .kek-meta',
			]
		);
		$this->end_controls_section();
	}
	...
	protected function render() {
		...
		$this->add_render_attribute('kek-social-count', 'class', ['kek-social-count', $settings['select_style']], true);
		$social_links = $this->get_settings('social_counter_list'); ?>
		<div <?php $this->print_render_attribute_string('kek-social-count'); ?>>
