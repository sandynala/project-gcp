<?php
	...
	/**
	 * KwsElementorKit Dyanmic select control.
	 *
	...
	class Dynamic_Select extends Base_Data_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'kek-dynamic-select', CFTKEK_URL . 'includes/controls/assets/js/kek-dynamic-select.js', array( 'jquery' ), CFTKEK_VER );
			wp_localize_script(
				'kek-dynamic-select',
				'ep_dynamic_select', [
					'nonce'    => wp_create_nonce( 'ep_dynamic_select' ),
					'action'   => 'kek_dynamic_select_input_data',
