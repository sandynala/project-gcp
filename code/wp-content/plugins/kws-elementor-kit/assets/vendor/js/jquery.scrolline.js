    ...
    $.extend({
        scrolline: function (options) {
            ...
            function Plugin(options) {
                ...
                this.$back = $(document.createElement('div')).addClass('kek-reading-progress-wrap');
            ...
            Plugin.prototype = {
                ...
                scrollListener : function() {
                    var self = this,
                        ...
                        var scrollPercent = (scrollValue) / (hDoc - hWin);
                        var scrollPercentRounded = Math.round(scrollPercent * 100);
                        

                    if(self.params.direction == 'vertical') {
                        scrollineVal = (scrollValue + hWin) * hWin / hDoc;
                        scrollineVal = scrollPercentRounded + '%'; // overridden by cft
