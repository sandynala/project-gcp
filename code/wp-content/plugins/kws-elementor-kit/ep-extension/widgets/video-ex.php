...
class Widget_VideoEx extends \Elementor\Widget_Base {
	/**
	 * Get widget name.
	 *
	...
	public function get_title() {
		return esc_html__( 'Video Ex', 'elementor' );
	}
	...
	public function get_keywords() {
		return [ 'videoex', 'player', 'embed', 'youtube', 'vimeo', 'dailymotion' ];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_videoex',
			[
				'label' => esc_html__( 'Video Ex', 'elementor' ),
			]
		);
