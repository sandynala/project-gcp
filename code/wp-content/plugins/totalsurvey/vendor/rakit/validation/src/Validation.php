...
namespace TotalSurveyVendors\Rakit\Validation;
! defined( 'ABSPATH' ) && exit();


use Closure;
use TotalSurveyVendors\Rakit\Validation\Rules\Interfaces\BeforeValidate;
use TotalSurveyVendors\Rakit\Validation\Rules\Interfaces\ModifyValue;
use TotalSurveyVendors\Rakit\Validation\Rules\Required;
...
class Validation
{
     ...
     * Constructor
     *
     * @param \TotalSurveyVendors\Rakit\Validation\Validator $validator
     * @param array $inputs
     * @param array $rules
     ...
     *
     * @param string $attributeKey
     * @return null|\TotalSurveyVendors\Rakit\Validation\Attribute
     */
     ...
     *
     * @return \TotalSurveyVendors\Rakit\Validation\ErrorBag
     */
     ...
     * Validate attribute
     *
     * @param \TotalSurveyVendors\Rakit\Validation\Attribute $attribute
     * @return void
     */
     ...
     * @param \TotalSurveyVendors\Rakit\Validation\Attribute $attribute
     * @param mixed $value
     * @param \TotalSurveyVendors\Rakit\Validation\Rule $ruleValidator
     * @return void
     */
     ...
     *
     * @param \TotalSurveyVendors\Rakit\Validation\Attribute $attribute
     * @param \TotalSurveyVendors\Rakit\Validation\Rule $rule
     * @return bool
     */
     ...
     * @param \TotalSurveyVendors\Rakit\Validation\Attribute $attribute
     * @param mixed $value
     * @param \TotalSurveyVendors\Rakit\Validation\Rule $validator
     * @return mixed
     */
     ...
     *
     * @return \TotalSurveyVendors\Rakit\Validation\Validator
     */
