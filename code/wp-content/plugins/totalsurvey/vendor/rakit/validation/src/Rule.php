...
use TotalSurveyVendors\Rakit\Validation\MissingRequiredParameterException;
...
abstract class Rule
{
    ...
    /** @var \TotalSurveyVendors\Rakit\Validation\Attribute|null */
    protected $attribute;
     ...
     *
     * @param array $params
     * @return \TotalSurveyVendors\Rakit\Validation\Rule
     */
