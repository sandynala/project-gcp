...
class View_General extends View {
	...
	function register_settings() {
		...
		add_settings_field( 'explkws_denied_caps', esc_html__( 'Capabilities',        'members' ), array( $this, 'field_explkws_denied_caps' ), 'members-settings', 'roles_caps' );
	...
	function validate_settings( $settings ) {
		...
		$settings['explkws_denied_caps'] = ! empty( $settings['explkws_denied_caps'] ) ? true : false;
	...
	/**
	 * Explkws denied caps field callback.
	 *
	 * @since  2.0.0
	 * @access public
	 * @return void
	 */
	public function field_explkws_denied_caps() { ?>

		<fieldset>

			<p>
				<label>
					<input type="checkbox" name="members_settings[explkws_denied_caps]" value="true" <?php checked( members_explkwsly_deny_caps() ); ?> />
